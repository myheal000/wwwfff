...
class ResNet_spd(nn.Module):
    ...
    def __init__(self, block, num_block=[]):
        ...
        self.conv2_x = self._make_layer(self.block, 64, self.num_block[0], 1)    # Here in_channels = 64, and num_block[0] = 64 and s = 1 
...
def resnet50_spd():
    ...
    """
    return ResNet_spd(BottleNeck, [3, 4, 6, 3])

def resnet101_spd():
    """ return a ResNet 101 object
    """
    return ResNet_spd(BottleNeck, [3, 4, 23, 3])

def resnet152_spd():
    """ return a ResNet 152 object
    """
    return ResNet_spd(BottleNeck, [3, 8, 36, 3])
